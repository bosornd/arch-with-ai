...
이 프로젝트는 소프트웨어 구조 설계 활동을 지원하는 에이전트 기반 시스템입니다. 이 프로젝트는 [`.cursor/agents/doc/workflow.md`](.cursor/agents/doc/workflow.md)에 명세된 구조 설계 워크플로우를 따라 체계적으로 아키텍처를 설계하고 소스 코드를 생성할 수 있도록 도와줍니다.
